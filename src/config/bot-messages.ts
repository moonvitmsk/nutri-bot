...
export const MSG_DEFAULTS: Record<string, string> = {
  ...
  // --- Onboarding flow ---
  onboarding_phone_activated: 'Спасибо! Полный доступ активирован бесплатно.',
  onboarding_phone_request: 'Поделись номером телефона — активирую полный бесплатный доступ.',
  ...
  // --- Trial / subscription ---
  msg_trial_activated: 'Спасибо! Полный доступ активирован бесплатно — все функции доступны. Отправь фото еды!',
  msg_trial_expired: 'Бесплатный период закончился. Поделись номером телефона ещё раз для продления, или используй QR-код Moonvit!',
  ...
  feature_lab: '🏥 Разбор анализов крови — мощная функция!\n\nВот что я делаю: считываю все маркеры (гемоглобин, холестерин, сахар...), сравниваю с нормами и подсказываю, какие продукты помогут.\n\nПоделись номером телефона — и эта функция станет доступна бесплатно!',
  feature_deepcheck: '🔬 Глубокая консультация — 4 AI-агента анализируют:\n• Твой рацион и баланс КБЖУ\n• Витамины и дефициты\n• Прогресс к цели\n• Персональные рекомендации\n\nПоделись номером — и получи доступ бесплатно!',
  feature_meal_plan: '📋 План питания — я составлю меню на день, неделю или месяц под твои параметры, аллергии и цель.\n\nПоделись номером телефона — и эта функция станет доступна!',
  feature_chat_limit: 'Бесплатные анализы закончились. Поделись номером телефона — и получи полный доступ бесплатно!',
  feature_photo_limit: 'Бесплатные анализы закончились. Поделись номером телефона — и получи полный доступ бесплатно!',
